...
describe('pages', function() {
  ...
  it('search searches for pages', function() {
    var query = { searchTerm: 'bar', country: 'xy', campaignUid: ['xy-12', 'xy-42'], charityUid: 'xy-123', page: 2, pageSize: 7 };
    ...
    expect(getJSON).toBeCalledWith(
      'https://everydayhero.com/api/v2/search/pages.jsonp' +
        '?q=bar&country_code=xy&campaign_id=xy-12,xy-42&charity_id=xy-123&type=&page=2&page_size=7',
